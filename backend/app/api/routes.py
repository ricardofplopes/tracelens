...
async def list_providers():
    ...
    providers = [
        ...
        ProviderInfo(name="facecheck", enabled=settings.FACECHECK_ENABLED, experimental=True, description="[Experimental] FaceCheck.ID face recognition search for social media", priority=priorities.get("facecheck", 5)),
